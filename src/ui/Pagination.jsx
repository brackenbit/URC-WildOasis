...
export default function Pagination({ resultsCount }) {
    ...
    const lastResult =
        currentPage === pageCount ? resultsCount : currentPage * resultsPerPage;
    ...
    return (
        <StyledPagination>
            <P>
                Showing <span>{firstResult}</span> to <span>{lastResult}</span>{" "}
